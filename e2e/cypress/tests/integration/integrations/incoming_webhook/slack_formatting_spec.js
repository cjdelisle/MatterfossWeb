...
describe('Incoming webhook', () => {
    ...
    describe('MM-T626 Incoming webhook is only image and fallback text', () => {
        ...
        it('second payload', () => {
            const search = id + '-2';
            const payload = {channel: 'off-topic', text: search, username: 'new_username', attachments: [{fallback: 'fallback text', image_url: imageUrl}], icon_url: 'https://matterfoss.com/wp-content/uploads/2022/02/icon_WS.png'};
