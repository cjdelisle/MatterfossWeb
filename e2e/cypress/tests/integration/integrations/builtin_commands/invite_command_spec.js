...
describe('Integrations', () => {
    ...
    it('MM-T660_4 /invite tests when used in DMs and GMs', () => {
        ...
        // * "channel handle" is a live link to https://docs.matterfoss.com/messaging/managing-channels.html#naming-a-channel
        cy.getLastPostId().then((postId) => {
            cy.get(`#post_${postId}`).
                contains('a', 'channel handle').should('have.attr', 'href', 'https://docs.matterfoss.com/messaging/managing-channels.html#naming-a-channel');
        });
    });
});
