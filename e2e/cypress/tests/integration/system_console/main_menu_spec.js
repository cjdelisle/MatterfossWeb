...
describe('Main menu', () => {
    ...
    it('MM-T910 Can open Administrators Guide', () => {
        cy.apiGetClientLicense().then(({isCloudLicensed}) => {
            const guideLink = isCloudLicensed ?
                'https://docs.matterfoss.com/guides/deployment.html' :
                'https://docs.matterfoss.com/guides/administration.html';
    ...
    it('MM-T911 Can open Troubleshooting Forum', () => {
        ...
        verifyLink('Troubleshooting Forum', 'https://forum.matterfoss.com/t/how-to-use-the-troubleshooting-forum/150');
    });
