...
import {ChannelTypes, PostTypes, TeamTypes, ThreadTypes, UserTypes} from 'matterfoss-redux/action_types';
...
import type {IDMappedObjects} from 'matterfoss-redux/types/utilities';
