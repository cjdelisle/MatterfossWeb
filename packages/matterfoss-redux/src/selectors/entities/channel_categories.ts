...
import {getCurrentChannelId, getMyChannelMemberships, makeGetChannelsForIds} from 'matterfoss-redux/selectors/entities/channels';
...
import {getMyPreferences, getTeammateNameDisplaySetting, shouldAutocloseDMs, getInt} from 'matterfoss-redux/selectors/entities/preferences';
