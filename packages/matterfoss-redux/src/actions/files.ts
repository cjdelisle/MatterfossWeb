...
import {batchActions, DispatchFunc, GetStateFunc, ActionFunc, Action} from 'matterfoss-redux/types/actions';

import {FileUploadResponse, FileSearchResultItem} from 'matterfoss-redux/types/files';
