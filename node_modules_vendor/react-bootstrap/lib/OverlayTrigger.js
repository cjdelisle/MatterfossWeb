...
function (_React$Component) {
  ...
  function OverlayTrigger(props, context) {
    ...
    _this.handleDelayedShow = _this.handleDelayedShow.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleDelayedHide = _this.handleDelayedHide.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleHide = _this.handleHide.bind((0, _assertThisInitialized2.default)(_this));
