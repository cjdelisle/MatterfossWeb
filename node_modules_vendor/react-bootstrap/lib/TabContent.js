...
function (_React$Component) {
  ...
  function TabContent(props, context) {
    ...
    _this.handlePaneEnter = _this.handlePaneEnter.bind((0, _assertThisInitialized2.default)(_this));
    _this.handlePaneExited = _this.handlePaneExited.bind((0, _assertThisInitialized2.default)(_this)); // Active entries in state will be `null` unless `animation` is set. Need
