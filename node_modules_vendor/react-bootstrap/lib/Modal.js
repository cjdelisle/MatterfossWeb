...
function (_React$Component) {
  ...
  function Modal(props, context) {
    ...
    _this.handleEntering = _this.handleEntering.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleExited = _this.handleExited.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleWindowResize = _this.handleWindowResize.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleDialogClick = _this.handleDialogClick.bind((0, _assertThisInitialized2.default)(_this));
    _this.setModalRef = _this.setModalRef.bind((0, _assertThisInitialized2.default)(_this));
    _this.state = {
      style: {}
    };
    return _this;
