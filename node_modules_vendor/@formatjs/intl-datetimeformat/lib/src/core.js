...
import { invariant, defineProperty, SupportedLocales, unpackData, InitializeDateTimeFormat, IsValidTimeZoneName, CanonicalizeTimeZoneName, DATE_TIME_PROPS, FormatDateTime, FormatDateTimeToParts, CanonicalizeLocaleList, parseDateTimeSkeleton, ToNumber, FormatDateTimeRange, FormatDateTimeRangeToParts, } from '@formatjs/ecma402-abstract';
...
DateTimeFormat.__addLocaleData = function __addLocaleData() {
    ...
    for (var _a = 0, data_1 = data; _a < data_1.length; _a++) {
        ...
        var _loop_1 = function (locale) {
            try {
                var _a = unpackData(locale, datum), dateFormat = _a.dateFormat, timeFormat = _a.timeFormat, dateTimeFormat = _a.dateTimeFormat, formats_1 = _a.formats, intervalFormats_1 = _a.intervalFormats, rawData = __rest(_a, ["dateFormat", "timeFormat", "dateTimeFormat", "formats", "intervalFormats"]);
                ...
                var _loop_2 = function (calendar) {
                    processedData.formats[calendar] = Object.keys(formats_1[calendar]).map(function (skeleton) {
                        return parseDateTimeSkeleton(skeleton, formats_1[calendar][skeleton], intervalFormats_1[skeleton], intervalFormats_1.intervalFormatFallback);
                    });
                };
