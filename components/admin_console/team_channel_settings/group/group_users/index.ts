...
import {ActionResult, GenericAction, ActionFunc} from 'matterfoss-redux/types/actions';
...
import {getMembersInTeams} from 'matterfoss-redux/selectors/entities/teams';
