            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'A comma-separated list of paths on the MatterFOSS server that are managed by another service. See [here](!https://docs.matterfoss.com/install/desktop-managed-resources.html) for more information.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.ENVIRONMENT.WEB_SERVER)),
                    },
                    {
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_markdown: true,
                        help_text_default: 'When enabled, supported document types are searchable by their content. Search results for existing documents may be incomplete [until a data migration is executed](!https://www.matterfoss.com/file-content-extraction).',
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.ENVIRONMENT.FILE_STORAGE)),
                        ),
                    },
                    ...
                    },
                    {
                        ...
                        help_text_markdown: true,
                        help_text_default: 'When true, encrypt files in Amazon S3 using server-side encryption with Amazon S3-managed keys. See [documentation](!https://docs.matterfoss.com/configure/configuration-settings.html#session-lengths) to learn more.',
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enable this feature to improve the quality and performance of MatterFOSS by sending error reporting and diagnostic information to MatterFOSS, Inc. Read our [privacy policy](!https://matterfoss.com/privacy-policy/) to learn more.',
                        help_text_markdown: true,
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, MatterFOSS will enable performance monitoring collection and profiling. Please see [documentation](!https://docs.matterfoss.com/deployment/metrics.html) to learn more about configuring performance monitoring for MatterFOSS.',
                        help_text_markdown: true,
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, "Ask the community" link appears on the MatterFOSS user interface and Help Menu, which allows users to join the MatterFOSS Community to ask questions and help others troubleshoot issues. When false, the link is hidden from users.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                        ...
                        help_text_default: 'The URL for the Help link on the MatterFOSS login page, sign-up pages, and Help Menu. If this field is empty, the Help link is hidden from users.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                    },
                    {
                        type: Constants.SettingsTypes.TYPE_TEXT,
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Add a link to a download page for the MatterFOSS apps. When a link is present, an option to "Download MatterFOSS Apps" will be added in the Product Menu so users can find the download page. Leave this field blank to hide the option from the Product Menu.',
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                        isHidden: it.configIsTrue('ExperimentalSettings', 'RestrictSystemAdmin'),
                    },
                    {
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When enabled, links to MatterFOSS messages will generate a preview for any users that have access to the original message. Please review our [documentation](!https://docs.matterfoss.com/messaging/sharing-messages.html) for details.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.POSTS)),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enable rendering of inline Latex code. If false, Latex can only be rendered in a code block using syntax highlighting. Please review our [documentation](!https://docs.matterfoss.com/messaging/formatting-text.html) for details about text formatting.',
                        help_text_markdown: true,
                        isDisabled: it.any(
                            it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.POSTS)),
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When enabled, System Admins will receive notices about available server upgrades and relevant system administration features. [Learn more about notices](!https://docs.matterfoss.com/manage/in-product-notices.html) in our documentation.',
                        help_text_markdown: true,
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When enabled, all users will receive notices about available client upgrades and relevant end user features to improve user experience. [Learn more about notices](!https://docs.matterfoss.com/manage/in-product-notices.html) in our documentation.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.NOTICES)),
                    },
                ],
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'New user accounts are restricted to the above specified email domain (e.g. "matterfoss.com") or list of comma-separated domains (e.g. "corp.matterfoss.com, matterfoss.com"). New teams can only be created by users from the above domain(s). This setting only affects email login for users.',
                        placeholder: t('admin.team.restrictExample'),
                        placeholder_default: 'E.g.: "corp.matterfoss.com, matterfoss.com"',
                    ...
                    },
                    {
                        ...
                        help_text_default: 'New user accounts are restricted to the above specified email domain (e.g. "matterfoss.com") or list of comma-separated domains (e.g. "corp.matterfoss.com, matterfoss.com"). New teams can only be created by users from the above domain(s). This setting affects email login for users. For Guest users, please add domains under Signup > Guest Access.',
                        placeholder: t('admin.team.restrictExample'),
                        placeholder_default: 'E.g.: "corp.matterfoss.com, matterfoss.com"',
                        isHidden: it.any(
                            it.not(it.licensed),
                    ...
                    },
                    {
                        ...
                        settings: [
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the first name of users in MatterFOSS. When set, users cannot edit their first name, since it is synchronized with the LDAP server. When left blank, users can set their first name in **Account Menu > Account Settings > Profile**.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the last name of users in MatterFOSS. When set, users cannot edit their last name, since it is synchronized with the LDAP server. When left blank, users can set their last name in **Account Menu > Account Settings > Profile**.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the nickname of users in MatterFOSS. When set, users cannot edit their nickname, since it is synchronized with the LDAP server. When left blank, users can set their nickname in **Account Menu > Account Settings > Profile**.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                            ...
                            },
                            {
                                ...
                                help_text_default: '(Optional) The attribute in the AD/LDAP server used to populate the position field in MatterFOSS. When set, users cannot edit their position, since it is synchronized with the LDAP server. When left blank, users can set their position in **Account Menu > Account Settings > Profile**.',
                                isDisabled: it.any(
                                    it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.LDAP)),
                                    it.all(
                                        it.stateIsFalse('LdapSettings.Enable'),
                    ...
                    },
                    {
                        ...
                        options: [
                            ...
                            },
                            {
                                ...
                                help_text_default: 'Follow provider directions for creating an OpenID Application. Most OpenID Connect providers require authorization of all redirect URIs. In the appropriate field, enter your-matterfoss-url/signup/openid/complete (example: http://domain.com/signup/openid/complete)',
                                help_text_markdown: true,
                            },
                        ],
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.AUTHENTICATION.OPENID)),
                ...
                settings: [
                    {
                        ...
                        help_text_default: 'When true, incoming webhooks will be allowed. To help combat phishing attacks, all posts from webhooks will be labelled by a BOT tag. See [documentation](!https://developers.matterfoss.com/integrate/admin-guide/admin-webhooks-incoming/) to learn more.',
                        help_text_markdown: true,
                    ...
                    },
                    {
                        ...
                        help_text_default: 'When true, outgoing webhooks will be allowed. See [documentation](!https://developers.matterfoss.com/integrate/admin-guide/admin-webhooks-outgoing/) to learn more.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.INTEGRATION_MANAGEMENT)),
                    },
                    {
                        ...
                        help_text_default: 'When true, custom slash commands will be allowed. See [documentation](!https://developers.matterfoss.com/integrate/admin-guide/admin-slash-commands/) to learn more.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.INTEGRATION_MANAGEMENT)),
                    },
                    {
                        ...
                        help_text_default: 'When true, MatterFOSS can act as an OAuth 2.0 service provider allowing MatterFOSS to authorize API requests from external applications. See [documentation](!https://developers.matterfoss.com/integrate/admin-guide/admin-oauth2/) to learn more.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.INTEGRATION_MANAGEMENT)),
                    },
                    {
                        ...
                        help_text_default: 'When true, webhooks, slash commands and other integrations, such as [Zapier](!https://developers.matterfoss.com/integrate/admin-guide/admin-zapier-integration/), will be allowed to change the username they are posting as. Note: Combined with allowing integrations to override profile picture icons, users may be able to perform phishing attacks by attempting to impersonate other users.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.INTEGRATION_MANAGEMENT)),
                    },
                    {
                        ...
                        help_text_default: 'When true, webhooks, slash commands and other integrations, such as [Zapier](!https://developers.matterfoss.com/integrate/admin-guide/admin-zapier-integration/), will be allowed to change the profile picture they post with. Note: Combined with allowing integrations to override usernames, users may be able to perform phishing attacks by attempting to impersonate other users.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.INTEGRATION_MANAGEMENT)),
                    },
                    {
                        ...
                        help_text_default: 'When true, users can create [user access tokens](!https://developers.matterfoss.com/integrate/admin-guide/admin-personal-access-token/) for integrations in **Account Menu > Account Settings > Security**. They can be used to authenticate against the API and give full access to the account.\n\n To manage who can create personal access tokens or to search users by token ID, go to the **User Management > Users** page.',
                        help_text_markdown: true,
                        isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.INTEGRATIONS.INTEGRATION_MANAGEMENT)),
                    },
                ],
            ...
            schema: {
                ...
                settings: [
                    ...
                    },
                    {
                        ...
                        help_text_default: 'Enable an updated SAML Library, which does not require the XML Security Library (xmlsec1) to be installed. Warning: Not all providers have been tested. If you experience issues, please contact support: [https://matterfoss.com/support/](!https://matterfoss.com/support/). Changing this setting requires a server restart before taking effect.',
                        help_text_markdown: true,
