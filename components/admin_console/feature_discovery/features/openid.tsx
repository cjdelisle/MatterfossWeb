...
const OpenIDFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            titleDefault='Integrate OpenID Connect with MatterFOSS Professional'
            ...
            learnMoreURL='https://docs.matterfoss.com/cloud/cloud-administration/sso-openid-connect.html'
