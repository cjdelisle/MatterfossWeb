...
const LDAPFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            titleDefault='Integrate Active Directory/LDAP with MatterFOSS Professional'
            ...
            learnMoreURL='https://www.matterfoss.com/docs-adldap/?utm_medium=product&utm_source=product-feature-discovery&utm_content=adldap'
