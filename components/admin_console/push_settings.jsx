        ...
        if (this.state.pushNotificationServerType === PUSH_NOTIFICATIONS_OFF) {
            sendHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Please see [documentation on push notifications](!https://docs.matterfoss.com/deploy/mobile-hpns.html) to learn more about setup options.'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Download [MatterFOSS iOS app](!https://matterfoss.com/matterfoss-ios-app/) from iTunes. Download [MatterFOSS Android app](!https://matterfoss.com/matterfoss-android-app/) from Google Play. Learn more about the [MatterFOSS Hosted Push Notification Service](!https://docs.matterfoss.com/deploy/mobile-hpns.html).'
                />
            );
            ...
            pushServerHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Download [MatterFOSS iOS app](!https://matterfoss.com/matterfoss-ios-app/) from iTunes. Download [MatterFOSS Android app](!https://matterfoss.com/matterfoss-android-app/) from Google Play. Learn more about the [MatterFOSS Test Push Notification Service](!https://docs.matterfoss.com/deploy/mobile-hpns.html).'
                />
            );
        } else {
            pushServerHelpText = (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Learn more about compiling and deploying your own mobile apps from an [Enterprise App Store](!https://docs.matterfoss.com/).'
                />
            );
        }
                ...
                <div className='form-group'>
                    ...
                    <div className='col-sm-8'>
                        ...
                        <FormattedMarkdownMessage
                            ...
                            defaultMessage=' I understand and accept the MatterFOSS Hosted Push Notification Service [Terms of Service](!https://matterfoss.com/hpns-terms/) and [Privacy Policy](!https://matterfoss.com/data-processing-addendum/).'
                        />
                    </div>
                </div>
            );
