...
export default class GeneralTab extends React.PureComponent {
    ...
    render() {
        ...
        if (this.props.activeSection === 'allowed_domains') {
                ...
                >
                    <div className='col-sm-12'>
                        <LocalizedInput
                            ...
                            onFocus={Utils.moveCursorToEnd}
                            placeholder={{id: t('general_tab.AllowedDomainsExample'), defaultMessage: 'corp.matterfoss.com, matterfoss.com'}}
            ...
            const allowedDomainsInfo = <span>{Utils.localizeMessage('general_tab.AllowedDomainsInfo', 'Users can only join the team if their email matches a specific domain (e.g. "matterfoss.com") or list of comma-separated domains (e.g. "corp.matterfoss.com, matterfoss.com").')}</span>;
