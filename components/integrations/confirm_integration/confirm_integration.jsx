            ...
            helpText = (
                <p>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your slash command is set up. The following token will be sent in the outgoing payload. Please use it to verify the request came from your Matterfoss team (details at [Slash Commands](!https://docs.matterfoss.com/developer/slash-commands.html)).'
                    />
                </p>
            );
            tokenText = (
            ...
            helpText = (
                <p>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your incoming webhook is set up. Please send data to the following URL (details at [Incoming Webhooks](!https://docs.matterfoss.com/developer/webhooks-incoming.html)).'
                    />
                </p>
            );
            tokenText = (
            ...
            helpText = (
                <p>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your outgoing webhook is set up. The following token will be sent in the outgoing payload. Please use it to verify that the request came from your Matterfoss team (details at [Outgoing Webhooks](!https://docs.matterfoss.com/developer/webhooks-outgoing.html)).'
                    />
                </p>
            );
            tokenText = (
            ...
            helpText.push(
                <p key='add_oauth_app.doneHelp'>
                    <FormattedMarkdownMessage
                        ...
                        defaultMessage='Your OAuth 2.0 application is set up. Please use the following Client ID and Client Secret when requesting authorization for your application (details at [oAuth 2 Applications](!https://docs.matterfoss.com/developer/oauth-2-0-applications.html)).'
                    />
                </p>,
            );
            helpText.push(
